...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Header Formalitas</a>
...
require_once 'class_mahasiswa.php';
    ...
    $mahasiswa1 = new Mahasiswa ("0707", "Cristiano Ronaldo");
    $mahasiswa1->prodi = "SI";
    $mahasiswa1->thn_angkatan=2003;
    $mahasiswa1->ipk=3.8;

    $mahasiswa2 = new Mahasiswa ("1010", "Kylan Mbappe");
    $mahasiswa2->prodi = "TI";
    $mahasiswa2->thn_angkatan=2012;
    $mahasiswa2->ipk=3.7;

    $mahasiswa3 = new Mahasiswa ("3030", "Lionel Messi");
    $mahasiswa3->prodi = "TI";
    $mahasiswa3->thn_angkatan=2011;
    $mahasiswa3->ipk=3.20;

    $mahasiswa4 = new Mahasiswa ("0090", "Mohammad Salah");
    $mahasiswa4->prodi = "SI";
    $mahasiswa4->thn_angkatan=2009;
    $mahasiswa4->ipk=4.00;
...
<footer class=" bg-light text-muted fixed-bottom">
  <div class="text-center p-2" style="background-color: rgba(0, 0, 0, 0.05);">
    <div>
      <p><b>Pemrograman Web 2 </b>| Mahasiswa : Muchlis Abdullah | STT NF - 2022</p>
    </div>
  </div>
</footer>
